...
// Calculates the time left until the target date and returns an array of years, months, days, hours, minutes, and seconds.
const calculateTimeLeft = (targetDate: Date): number[] => {
    const difference = targetDate.getTime() - new Date().getTime()

    if (difference <= 0) {
        return [0, 0, 0, 0, 0, 0] // zeros instead of undefined or null
    }
